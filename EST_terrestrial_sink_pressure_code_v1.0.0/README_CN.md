# EST投稿配套代码包：陆地生态系统碳汇基准与工业排放压力评估

版本：1.0.0

## 一、代码包的复现范围

本代码包针对论文中“陆地生态系统碳汇基准与工业排放压力评估”部分，不声称复现整篇论文的历史排放清单、LMDI分解或MESSAGEix情景建模。
...
ArcPy和Spatial Analyst需要ArcGIS许可。本代码包如实保留原始执行环境，不宣称完全跨平台。
...
80%、100%和120%条件是敏感性设置，不是对2060年实际碳汇的确定性预测。
